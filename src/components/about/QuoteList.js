...
const quotes = [
  ...
  {
    quote:
      "The past is the past. And the only direction in life that matters is forward. Never Backward.",
  ...
  {
    quote: "Un grand pouvoir entraine de grandes irresponsabilites",
